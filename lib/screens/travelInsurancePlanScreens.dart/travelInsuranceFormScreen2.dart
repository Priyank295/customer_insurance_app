...
class TravelInsuranceFormScreen2 extends StatefulWidget {
  const TravelInsuranceFormScreen2({super.key});

  @override
  State<TravelInsuranceFormScreen2> createState() =>
      _TravelInsuranceFormScreen2State();
}

bool conditions = false;

class _TravelInsuranceFormScreen2State
    extends State<TravelInsuranceFormScreen2> {
  @override
