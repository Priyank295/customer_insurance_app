...
import 'travelInsuranceFormScreen1.dart';

class TravelInsurancePlansScreen extends StatefulWidget {
  static const String travelPlansScreen = "/travelPlansScreen";
  const TravelInsurancePlansScreen({super.key});

  @override
  State<TravelInsurancePlansScreen> createState() =>
      _TravelInsurancePlansScreenState();
}
...
class _TravelInsurancePlansScreenState
    extends State<TravelInsurancePlansScreen> {
  @override
        ...
        child: SafeArea(
          child: Container(
            ...
            child: Column(children: [
              CustomPolicyAppBar(context, "Travel Insurance Plan"),
              SizedBox(
                height: 20,
              ),
              ListView.builder(
    ...
    return InkWell(
      onTap: () {
        Navigator.push(context,
            MaterialPageRoute(builder: (ctx) => TravelInsuranceFormScreen1()));
      },
      child: Container(
