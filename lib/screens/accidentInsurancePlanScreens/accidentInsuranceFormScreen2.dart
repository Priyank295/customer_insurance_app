...
class AccidentInsuranceFormScreen2 extends StatefulWidget {
  static const String AccidentForm2 = "/accidentForm2";
  const AccidentInsuranceFormScreen2({super.key});

  @override
  State<AccidentInsuranceFormScreen2> createState() =>
      _AccidentInsuranceFormScreen2State();
}

bool conditions = false;

class _AccidentInsuranceFormScreen2State
    extends State<AccidentInsuranceFormScreen2> {
  @override
