...
import 'accidentInsuranceFormScreen1.dart';

class AccidentInsurancePlansScreen extends StatefulWidget {
  static const String AccidentPlansScreen = "/accidentPlansScreen";
  const AccidentInsurancePlansScreen({super.key});

  @override
  State<AccidentInsurancePlansScreen> createState() =>
      _AccidentInsurancePlansScreenState();
}
...
class _AccidentInsurancePlansScreenState
    extends State<AccidentInsurancePlansScreen> {
  @override
        ...
        child: SafeArea(
          child: Container(
            ...
            child: Column(children: [
              CustomPolicyAppBar(context, "Personal Accident Insurance Plan"),
              SizedBox(
                height: 20,
              ),
              ListView.builder(
    ...
    return InkWell(
      onTap: () {
        Navigator.push(
            context,
            MaterialPageRoute(
                builder: (ctx) => AccidentInsuranceFormScreen1()));
      },
      child: Container(
