...
class PetInsuranceFormScreen2 extends StatefulWidget {
  const PetInsuranceFormScreen2({super.key});

  @override
  State<PetInsuranceFormScreen2> createState() =>
      _PetInsuranceFormScreen2State();
}

bool conditions = false;

class _PetInsuranceFormScreen2State extends State<PetInsuranceFormScreen2> {
  @override
