...
import 'petInsuranceFormScreen1.dart';

class PetInsurancePlansScreen extends StatefulWidget {
  static const petPlansScreen = "/petPlansScreen";
  const PetInsurancePlansScreen({super.key});

  @override
  State<PetInsurancePlansScreen> createState() =>
      _PetInsurancePlansScreenState();
}
...
class _PetInsurancePlansScreenState extends State<PetInsurancePlansScreen> {
  @override
        ...
        child: SafeArea(
          child: Container(
            ...
            child: Column(children: [
              CustomPolicyAppBar(context, "Pet Insurance Plan"),
              SizedBox(
                height: 20,
              ),
              ListView.builder(
    ...
    return InkWell(
      onTap: () {
        Navigator.push(
            context,
            MaterialPageRoute(
                builder: (ctx) => const PetInsuranceFormScreen1()));
      },
      child: Container(
