...
import 'homeInsuranceformScreen1.dart';

class HomeInsurancePlansScreen extends StatefulWidget {
  static const HomePlansScreen = "/homePlansScreen";
  const HomeInsurancePlansScreen({super.key});

  @override
  State<HomeInsurancePlansScreen> createState() =>
      _HomeInsurancePlansScreenState();
}
...
class _HomeInsurancePlansScreenState extends State<HomeInsurancePlansScreen> {
  @override
        ...
        child: SafeArea(
          child: Container(
            ...
            child: Column(children: [
              CustomPolicyAppBar(context, "Home Insurance Plan"),
              SizedBox(
                height: 20,
              ),
              ListView.builder(
    ...
    return InkWell(
      onTap: () {
        Navigator.push(context,
            MaterialPageRoute(builder: (ctx) => HomeInsuranceFormScreen1()));
      },
      child: Container(
