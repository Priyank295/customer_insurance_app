...
class HomeInsuranceFormScreen2 extends StatefulWidget {
  static const HomeForm2 = "/homeForm2";
  const HomeInsuranceFormScreen2({super.key});

  @override
  State<HomeInsuranceFormScreen2> createState() =>
      _HomeInsuranceFormScreen2State();
}

bool conditions = false;

class _HomeInsuranceFormScreen2State extends State<HomeInsuranceFormScreen2> {
  @override
