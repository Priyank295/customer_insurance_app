...
class MarineInsuranceFormScreen2 extends StatefulWidget {
  const MarineInsuranceFormScreen2({super.key});

  @override
  State<MarineInsuranceFormScreen2> createState() =>
      _MarineInsuranceFormScreen2State();
}

bool conditions = false;

class _MarineInsuranceFormScreen2State
    extends State<MarineInsuranceFormScreen2> {
  @override
