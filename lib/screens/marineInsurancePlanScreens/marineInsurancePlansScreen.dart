...
import 'marineInsuranceFormScreen1.dart';

class MarineInsurancePlansScreen extends StatefulWidget {
  static const String marinePlansScreen = "/marinePlansScreen";
  const MarineInsurancePlansScreen({super.key});

  @override
  State<MarineInsurancePlansScreen> createState() =>
      _MarineInsurancePlansScreenState();
}
...
class _MarineInsurancePlansScreenState
    extends State<MarineInsurancePlansScreen> {
  @override
        ...
        child: SafeArea(
          child: Container(
            ...
            child: Column(children: [
              CustomPolicyAppBar(context, "Marine Insurance Plan"),
              SizedBox(
                height: 20,
              ),
              ListView.builder(
    ...
    return InkWell(
      onTap: () {
        Navigator.push(context,
            MaterialPageRoute(builder: (ctx) => MarineInsuranceFormScreen1()));
      },
      child: Container(
