...
import 'officeInsuranceFormScreen1.dart';

class OfficeInsurancePlansScreen extends StatefulWidget {
  static const officePlansScreen = "/officePlansScreen";
  const OfficeInsurancePlansScreen({super.key});

  @override
  State<OfficeInsurancePlansScreen> createState() =>
      _OfficeInsurancePlansScreenState();
}
...
class _OfficeInsurancePlansScreenState
    extends State<OfficeInsurancePlansScreen> {
  @override
        ...
        child: SafeArea(
          child: Container(
            ...
            child: Column(children: [
              CustomPolicyAppBar(context, "Office Insurance Plan"),
              SizedBox(
                height: 20,
              ),
              ListView.builder(
    ...
    return InkWell(
      onTap: () {
        Navigator.push(context,
            MaterialPageRoute(builder: (ctx) => OfficeInsuranceFormScreen1()));
      },
      child: Container(
