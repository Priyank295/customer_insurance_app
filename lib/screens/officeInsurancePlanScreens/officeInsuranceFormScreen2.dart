...
class OfficeInsuranceFormScreen2 extends StatefulWidget {
  const OfficeInsuranceFormScreen2({super.key});

  @override
  State<OfficeInsuranceFormScreen2> createState() =>
      _OfficeInsuranceFormScreen2State();
}

bool conditions = false;

class _OfficeInsuranceFormScreen2State
    extends State<OfficeInsuranceFormScreen2> {
  @override
