...
import 'lifeInsuranceFormScreen1.dart';

class LifeInsurancePlansScreen extends StatefulWidget {
  static const LifePlansScreen = "/lifePlansScreen";
  const LifeInsurancePlansScreen({super.key});

  @override
  State<LifeInsurancePlansScreen> createState() =>
      _LifeInsurancePlansScreenState();
}
...
class _LifeInsurancePlansScreenState extends State<LifeInsurancePlansScreen> {
  @override
        ...
        child: SafeArea(
          child: Container(
            ...
            child: Column(children: [
              CustomPolicyAppBar(context, "Life Insurance Plan"),
              SizedBox(
                height: 20,
              ),
              ListView.builder(
    ...
    return InkWell(
      onTap: () {
        Navigator.push(context,
            MaterialPageRoute(builder: (ctx) => LifeInsuranceformScreen1()));
      },
      child: Container(
