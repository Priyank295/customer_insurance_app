...
class IllnessInsuranceFormScreen2 extends StatefulWidget {
  const IllnessInsuranceFormScreen2({super.key});

  @override
  State<IllnessInsuranceFormScreen2> createState() =>
      _IllnessInsuranceFormScreen2State();
}

bool conditions = false;

class _IllnessInsuranceFormScreen2State
    extends State<IllnessInsuranceFormScreen2> {
  @override
