...
import 'illnessInsuranceFormScreen1.dart';

class IllnessInsurancePlansScreen extends StatefulWidget {
  static const String illnessPlansScreen = "/illnessPlansScreen";
  const IllnessInsurancePlansScreen({super.key});

  @override
  State<IllnessInsurancePlansScreen> createState() =>
      _IllnessInsurancePlansScreenState();
}
...
class _IllnessInsurancePlansScreenState
    extends State<IllnessInsurancePlansScreen> {
  @override
        ...
        child: SafeArea(
          child: Container(
            ...
            child: Column(children: [
              CustomPolicyAppBar(context, "Critical Illness Insurance Plan"),
              SizedBox(
                height: 20,
              ),
              ListView.builder(
    ...
    return InkWell(
      onTap: () {
        Navigator.push(
            context,
            MaterialPageRoute(
                builder: (ctx) => const IllnessInsuranceFormScreen1()));
      },
      child: Container(
