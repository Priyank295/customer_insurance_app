...
class AutomativeInsuranceFormScreen2 extends StatefulWidget {
  const AutomativeInsuranceFormScreen2({super.key});

  @override
  State<AutomativeInsuranceFormScreen2> createState() =>
      _AutomativeInsuranceFormScreen2State();
}

bool conditions = false;

class _AutomativeInsuranceFormScreen2State
    extends State<AutomativeInsuranceFormScreen2> {
  @override
