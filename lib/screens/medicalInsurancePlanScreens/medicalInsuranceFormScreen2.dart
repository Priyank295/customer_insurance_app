...
class MedicalInsuranceFormScreen2 extends StatefulWidget {
  static const MedicalForm2 = "/medicalForm2";

  const MedicalInsuranceFormScreen2({super.key});

  @override
  State<MedicalInsuranceFormScreen2> createState() =>
      _MedicalInsuranceFormScreen2State();
}

bool conditions = false;

class _MedicalInsuranceFormScreen2State
    extends State<MedicalInsuranceFormScreen2> {
  @override
