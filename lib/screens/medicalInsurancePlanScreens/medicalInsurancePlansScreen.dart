...
import 'medicalInsuranceFormScreen1.dart';

class MedicalInsurancePlansScreen extends StatefulWidget {
  static const MedicalPlansScreen = "/medicalPlansScreen";
  const MedicalInsurancePlansScreen({super.key});

  @override
  State<MedicalInsurancePlansScreen> createState() =>
      _MedicalInsurancePlansScreenState();
}
...
class _MedicalInsurancePlansScreenState
    extends State<MedicalInsurancePlansScreen> {
  @override
        ...
        child: SafeArea(
          child: Container(
            ...
            child: Column(children: [
              CustomPolicyAppBar(context, "Individual Medical Insurance Plan"),
              SizedBox(
                height: 20,
              ),
              ListView.builder(
    ...
    return InkWell(
      onTap: () {
        Navigator.push(context,
            MaterialPageRoute(builder: (ctx) => MedicalInsuranceFormScreen1()));
      },
      child: Container(
