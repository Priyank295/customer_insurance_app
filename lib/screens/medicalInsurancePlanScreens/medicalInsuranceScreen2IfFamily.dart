...
import '../../widgets/custom_drop_down_textfield.dart';
...
MedicalIfFamilyController medicalIfFamilyController =
    Get.put(MedicalIfFamilyController());
                ...
                return TypeAheadFormField(
                  ...
                  itemBuilder: (context, String suggestion) {
                    return ListTile(
                      ...
                      // ),
                      leading: MSHCheckbox(
                        value: controller.selectedItems.contains(suggestion),
                        ...
                        onChanged: (selected) {
                          controller.onItemClicked(suggestion);
                        },
                      ),
                      title: Text(
                        suggestion,
                  ...
                  onSuggestionSelected: (String suggestion) {
                    controller.onItemClicked(suggestion);
                    print(medicalIfFamilyController.selectedItems);
                  },
                );
              }),
        ));
